...
app.get('/player_info', function(req, res) {
 ...
 app.get('/player_info/post', function(req, res) {
   var selectedPlayer = req.body.player_choice;
  var query1 = 'SELECT * FROM football_players;';
   var query2 = 'SELECT * FROM football_players WHERE id = '+selectedPlayer+';';
   var query3 = 'SELECT COUNT(*) FROM football_games FULL JOIN football_players ON football_players.id = ANY(football_games.players) WHERE football_players.id = '+selectedPlayer+';';
   db.task('get-everything', task => {
       return task.batch([
         task.any(query1),
         task.any(query2),
